  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
       <!--  <h1 class="text-light"><a href="index.html">LINKAGE</a></h1> -->
        <!-- Uncomment below if you prefer to use an image logo -->
         <a href="index.php"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>
      </div>
      <div class="dropdown">
          <a class="dropbtn" href="#"><strong>Online Insurance</strong></a>
          <div class="dropdown-content">
            <a href="https://linkageassuranceplc.com/onlinemotor/">Motor Insurance</a>
            <a href="https://linkageassuranceplc.com/marinecert/">Marine Insurance</a>
          </div>
        </div>
          ...
          <li class="drop-down"><a href=""><strong>About</strong></a>
            <ul>
              ...
              <li class="drop-down"><a href=""><i class="icofont-team" style="color: #000"></i>&nbsp;Our Team</a>
                <ul>
                  <li><a href="#"><i class="icofont-people" style="color: #000"></i>&nbsp;Board of Directors</a></li><hr>
                  <li><a href="#"><i class="icofont-team" style="color: #000"></i>&nbsp;Management Team</a></li>
                </ul>
              </li>
