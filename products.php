    ...
    <section id="services" class="services" style="background: #f1f1f1;">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3 col-md-6 automobile" data-aos="fade-up">
            <div class="icon-box" data-aos="fade-up">
             <!--  <div class="icon"><i class="icofont-car"></i></div> -->
              <h3 class="title"><a href="automobile.php">AUTOMOBILE</a></h3>
              <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate.&nbsp; <span><a href="automobile.php">Read More</a></span> </p>
            </div>
          </div>
          ...
          <div class="col-md-3 marine" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <!-- <div class="icon"><i class="icofont-first-aid"></i></div> -->
          ...
          <div class="col-md-3 oil" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <!-- <div class="icon"><i class="icofont-home"></i></div> -->
